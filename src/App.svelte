  ...
  async function getoutoldevents(levents){
    ...
    for(let i=0;i<levents.length;i++){
      ...
      if(levents[i][2].trim() == 'ภูเก็ต'){
        levents[i][6] = 'https://anywhere.pwisetthon.com/https://www.phuket.go.th/webpk/images/introduce/logo-phuket2565.jpg'
      }
...
<Container>
  <Row>
    <Col sm="12" md={{ size: 6, offset: 3 }}>
      <Card class="mb-1" body><center><h2>ตารางงาน</h2></center></Card>
